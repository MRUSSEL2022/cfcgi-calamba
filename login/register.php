     ...
     <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh">
       <form class="border shadow p-3 rounded" action="php/signup.php" method="POST" style="width: 450px;">
         ...
         <h2 class="text-center p-3">
           <span style="color:#4ccee8;">CFCGI </span>REGISTER
         </h2>
         <div class="input-group">
           <span class="input-group-text">First and last name</span>
           <input type="text" name="name" class="form-control" id="name" required>
         ...
         <!-- An element to toggle between password visibility --> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox" onclick="confirmPassword()">Confirm Password <div id="passwords"></div>
         <br>
         <div class="input-group mb-3">
         ...
         <button type="back" class="btn btn-primary">
           <a href="index.php" class="mt-3">Back </button>
