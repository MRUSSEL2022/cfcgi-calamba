...
<html lang="en">
  ...
  <body>
    <!--wrapper start--> 
    <?php require 'includes/header.php' ?> <div class=""> <?php if ($_SESSION['role'] == 'chaplain'){ ?>
      <!-- for admin --> 
      <?php }else {?>
      <!-- for users -->
      <!--sidebar start--> 
      ...
      <div class="main-container">
        ...
        <div class="widget-post" aria-labelledby="post-header-title">
          <div class="widget-post__header">
            <h2 class="widget-post__title" id="post-header-title">
              <i class="fa fa-pencil" aria-hidden="true"></i> Write Me
            </h2>
          </div>
              ...
              <div class="post-actions__attachments">
                <button type="button" class="btn post-actions__upload attachments--btn">
                  <label for="upload-image" class="post-actions__label">
                    <i class="fa fa-upload" aria-hidden="true"></i> upload image </label>
                </button>
        ...
        <br />
        <br />
        <!-- END POST BOX --> <?php require 'includes/forum.php' ?>
      </div>
